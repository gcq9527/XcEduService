...
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-bannerB.jpg);"></div>-->
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-bannerA.jpg);"></div>-->
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-banner3.png);"></div>-->
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-bannerB.jpg);"></div>-->
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-bannerA.jpg);"></div>-->
<#--        <div class="item" style="background-image: url(http://localhost:63343/xc-ui-pc-static-portal/img/widget-banner3.png);"></div>-->
    <#if model??><#--如果为空-->
        <#list model as item> <#--拿到数据库中的图片地址-->
